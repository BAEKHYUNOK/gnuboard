...
<div id="wrapper">
	<aside id="aside">
	    ...
	    <div id="aside_ct">
	        <div class="short_cut">
	            <ul>
	                <li class="f_short_cut"><strong><a href="http://naver.com">네이버</a></strong></li>
	                <li><strong><a href="http://luckytory.shop">럭키토리샵</a></strong></li>
	                <li><strong><a href="http://nangmanhomecare.shop/bbs/board.php?bo_table=gallery">갤러리</a></strong></li>
	            </ul>
	        </div>
	        <div class="aside_lt">
	            <?php
